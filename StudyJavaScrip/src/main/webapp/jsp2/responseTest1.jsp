...
<body>
	...
	- response.XXX() 메서드를 호출하여 값 변경 및 기능 호출 가능
	...
	4) 클라이언트 요청에 대한 페이지 이동(= 포워딩) 처리
	   => response.sendRedirect("이동할 페이지 URL");
	   - 포워딩 발생 시 주소 표시줄의 URL 이 이동할 페이지의 URL 로 변경됨
	...
	// => 자바스크립트의 location.href 와 마찬가지로 실행되는 즉시 페이지가 이동
// 	response.sendRedirect("responseTest1_result.jsp");
	response.sendRedirect("http://www.naver.com");
	%>
	
	<!-- 2. 하이퍼링크를 사용하여 페이지 이동(responseTest1_result.jsp) -->
	<a href="responseTest1_result.jsp">responseTest1_result.jsp 페이지로 이동</a>
